...
class EUpdateDialog extends CWidget
{
  ...
  public function run()
  {
    ...
    $cs->registerScriptFile( $assets . '/EUpdateDialog.'.Yii::app()->language.'.js' );
    
    // Add cookie script and csrf cookie if using CSRF validation.
    if( Yii::app()->request->enableCsrfValidation )
    {
      $cs->registerScript('csrf','var csrfName="'.Yii::app()->request->csrfTokenName.'"',  CClientScript::POS_HEAD);
